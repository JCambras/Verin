...
type Action = "household.read" | "policy.read" | "policy.publish" | "decision.evaluate";
const ROLE_ACTIONS: Record<string, readonly Action[]> = { advisor: ["household.read", "policy.read", "policy.publish", "decision.evaluate"] };
