...
export default function AppHome() {
  const cards = [
    { href: "/app/demo/setup", title: "Money-movement governance", desc: "Set up two governed profiles, review signed impact, and run the same Smiths request under both.", regulation: "Phase 1 setup-first replacement" },
