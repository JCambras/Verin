 ...
 * never a window into our error taxonomy (D-253). Forwarding the flow's own
 ...
 *
 * SHARED (D-257) because the demo's simulate-sign affordance drives the very same
 ...
 * and SHA-256 digests across this boundary before (D-256/D-258).
 */
