 ...
 * The backlog counts rows still awaiting delivery ('pending' + 'claimed');
 * 'parked' dead-letter rows are stuck, not pending, and are surfaced by the
 * park-time alert instead.
 */
