...
const NON_PII_ESCAPES: Array<{ ref: string; why: string }> = [
  ...
  { ref: "src/contracts/decision-core/v1-7/decision.ts :: ExplanationTenantReferences.evidenceSnapshotRefs", why: "a list of branded EvidenceSnapshotId REFERENCES (v3 §5) - the pointer to a snapshot, never the snapshot's contents" },
  { ref: "src/contracts/decision-core/v1-7/decision.ts :: ExplanationTenantReferences.childNodes.evidenceSnapshotRefs", why: "a list of branded EvidenceSnapshotId REFERENCES (v3 §5) - the pointer to a snapshot, never the snapshot's contents" },
  { ref: "src/contracts/decision-core/v1-7/decision.ts :: NormalizableDecisionRecord.result.executionPlan.steps.preconditions.requiredEvidenceSnapshotRefs", why: "branded EvidenceSnapshotId references an execution precondition must revalidate against - identifiers, not evidence contents" },
  { ref: "src/contracts/decision-core/v1-7/decision.ts :: NormalizableDecisionRecord.result.executionPlan.steps.compensatingAction.preconditions.requiredEvidenceSnapshotRefs", why: "branded EvidenceSnapshotId references an execution precondition must revalidate against - identifiers, not evidence contents" },
  { ref: "src/contracts/decision-core/v1-7/decision.ts :: NormalizableDecisionRecord.result.blockers.resolvingEvidence", why: "EvidenceRequest descriptors (kind + scope) naming what would unblock a decision - a request FOR evidence, never evidence itself" },
  { ref: "src/contracts/decision-core/v1-7/decision.ts :: BlockedDecision.blockers.resolvingEvidence", why: "EvidenceRequest descriptors (kind + scope) naming what would unblock a decision - a request FOR evidence, never evidence itself" },
  { ref: "src/contracts/decision-core/v1-7/decision.ts :: DecisionResult.blockers.resolvingEvidence", why: "EvidenceRequest descriptors (kind + scope) naming what would unblock a decision - a request FOR evidence, never evidence itself" },
  { ref: "src/contracts/decision-core/v1-7/decision.ts :: RevaluationCondition.evidenceKind", why: "a branded EvidenceKind discriminator (which KIND of evidence is wanted), carrying no subject data" },
  { ref: "src/contracts/decision-core/v1-7/decision.ts :: DecisionRecordV1_7_0.explanationTrace.evidenceSnapshotRefs", why: "a list of branded EvidenceSnapshotId REFERENCES (v3 §5) - the pointer to a snapshot, never the snapshot's contents" },
  { ref: "src/contracts/decision-core/v1-7/decision.ts :: DecisionRecordV1_7_0.reevaluateWhen.evidenceKind", why: "a branded EvidenceKind discriminator (which KIND of evidence is wanted), carrying no subject data" },
  { ref: "src/contracts/decision-core/v1-7/evidence.ts :: DecisionInputBundleV1_7_0.evidenceSnapshotRefs", why: "a list of branded EvidenceSnapshotId REFERENCES (v3 §5) - the pointer to a snapshot, never the snapshot's contents" },
  { ref: "src/contracts/decision-core/v1-7/execution.ts :: NormalizableExecutionPrecondition.requiredEvidenceSnapshotRefs", why: "branded EvidenceSnapshotId references an execution precondition must revalidate against - identifiers, not evidence contents" },
  { ref: "src/contracts/decision-core/v1-7/execution.ts :: ExecutionPrecondition.requiredEvidenceSnapshotRefs", why: "branded EvidenceSnapshotId references an execution precondition must revalidate against - identifiers, not evidence contents" },
  { ref: "src/contracts/decision-core/v1-7/execution.ts :: NormalizableExternalAction.preconditions.requiredEvidenceSnapshotRefs", why: "branded EvidenceSnapshotId references an execution precondition must revalidate against - identifiers, not evidence contents" },
  { ref: "src/contracts/decision-core/v1-7/execution.ts :: RetrySafeExternalAction.preconditions.requiredEvidenceSnapshotRefs", why: "branded EvidenceSnapshotId references an execution precondition must revalidate against - identifiers, not evidence contents" },
  { ref: "src/contracts/decision-core/v1-7/execution.ts :: CompensatingAction.preconditions.requiredEvidenceSnapshotRefs", why: "branded EvidenceSnapshotId references an execution precondition must revalidate against - identifiers, not evidence contents" },
  { ref: "src/contracts/decision-core/v1-7/execution.ts :: ExecutionStep.preconditions.requiredEvidenceSnapshotRefs", why: "branded EvidenceSnapshotId references an execution precondition must revalidate against - identifiers, not evidence contents" },
  { ref: "src/contracts/decision-core/v1-7/execution.ts :: NormalizableExecutionPlan.steps.preconditions.requiredEvidenceSnapshotRefs", why: "branded EvidenceSnapshotId references an execution precondition must revalidate against - identifiers, not evidence contents" },
  { ref: "src/contracts/decision-core/v1-7/execution.ts :: NormalizableExecutionPlan.steps.compensatingAction.preconditions.requiredEvidenceSnapshotRefs", why: "branded EvidenceSnapshotId references an execution precondition must revalidate against - identifiers, not evidence contents" },
  { ref: "src/contracts/decision-core/v1-7/explanation.ts :: ExplanationNode.evidenceSnapshotRefs", why: "a list of branded EvidenceSnapshotId REFERENCES (v3 §5) - the pointer to a snapshot, never the snapshot's contents" },
  { ref: "src/contracts/decision-core/v1-7/explanation.ts :: ExplanationNode.childNodes.evidenceSnapshotRefs", why: "a list of branded EvidenceSnapshotId REFERENCES (v3 §5) - the pointer to a snapshot, never the snapshot's contents" },
  { ref: "src/contracts/decision-core/v1-7/ids.ts :: ExecutionPreconditionReferenceSet.requiredEvidenceSnapshotRefs", why: "branded EvidenceSnapshotId references an execution precondition must revalidate against - identifiers, not evidence contents" },
  { ref: "src/contracts/decision-core/v1-7/normalization.ts :: NormalizableExplanationNode.evidenceSnapshotRefs", why: "a list of branded EvidenceSnapshotId REFERENCES (v3 §5) - the pointer to a snapshot, never the snapshot's contents" },
  { ref: "src/contracts/decision-core/v1-7/normalization.ts :: NormalizableExplanationNode.childNodes.evidenceSnapshotRefs", why: "a list of branded EvidenceSnapshotId REFERENCES (v3 §5) - the pointer to a snapshot, never the snapshot's contents" },
  { ref: "src/contracts/decision-core/v1-7/serialization.ts :: BundleHashPayloadV1_7_0.evidenceSnapshotRefs", why: "a list of branded EvidenceSnapshotId REFERENCES (v3 §5) - the pointer to a snapshot, never the snapshot's contents" },
  { ref: "src/contracts/decision-core/v1-7/serialization.ts :: DecisionHashPayloadV1_7_0.explanationTrace.evidenceSnapshotRefs", why: "a list of branded EvidenceSnapshotId REFERENCES (v3 §5) - the pointer to a snapshot, never the snapshot's contents" },
  { ref: "src/contracts/decision-core/v1-7/serialization.ts :: DecisionHashPayloadV1_7_0.reevaluateWhen.evidenceKind", why: "a branded EvidenceKind discriminator (which KIND of evidence is wanted), carrying no subject data" },
  { ref: "src/contracts/decision-core/v1-7/serialization.ts :: BundleHashPreimage.payload.evidenceSnapshotRefs", why: "a list of branded EvidenceSnapshotId REFERENCES (v3 §5) - the pointer to a snapshot, never the snapshot's contents" },
  { ref: "src/contracts/decision-core/v1-7/serialization.ts :: DecisionHashPreimage.payload.explanationTrace.evidenceSnapshotRefs", why: "a list of branded EvidenceSnapshotId REFERENCES (v3 §5) - the pointer to a snapshot, never the snapshot's contents" },
  { ref: "src/contracts/decision-core/v1-7/serialization.ts :: DecisionHashPreimage.payload.reevaluateWhen.evidenceKind", why: "a branded EvidenceKind discriminator (which KIND of evidence is wanted), carrying no subject data" },
  { ref: "src/contracts/decision-core/v1-7/serialization.ts :: NormalizableDecisionInputBundle.evidenceSnapshotRefs", why: "a list of branded EvidenceSnapshotId REFERENCES (v3 §5) - the pointer to a snapshot, never the snapshot's contents" },
  { ref: "src/contracts/decision-core/v1-7/trigger.ts :: EvidenceRequest.evidenceKind", why: "a branded EvidenceKind discriminator (which KIND of evidence is wanted), carrying no subject data" },
  { ref: "src/contracts/decision-core/v1-7/trigger.ts :: ResolvableBlocker.resolvingEvidence", why: "EvidenceRequest descriptors (kind + scope) naming what would unblock a decision - a request FOR evidence, never evidence itself" },
  { ref: "src/contracts/decision-core/v1-7/trigger.ts :: ResolvableBlocker.resolvingEvidence.evidenceKind", why: "a branded EvidenceKind discriminator (which KIND of evidence is wanted), carrying no subject data" },
  { ref: "src/contracts/decision-core/v1-7/trigger.ts :: NormalizableResolvableBlocker.resolvingEvidence", why: "EvidenceRequest descriptors (kind + scope) naming what would unblock a decision - a request FOR evidence, never evidence itself" },
  { ref: "src/contracts/decision-core/v1-7/trigger.ts :: ResolutionState.gaps.evidenceKind", why: "a branded EvidenceKind discriminator (which KIND of evidence is wanted), carrying no subject data" },
  { ref: "src/domain/ledger/projections.ts :: ProjectionFoldInput.event.evidenceSnapshotRef", why: "immutable evidence snapshot reference" },
  { ref: "src/infrastructure/ledger/ledger-projection-store.ts :: PreparedProjection.event.evidenceSnapshotRef", why: "immutable evidence snapshot reference" },
  { ref: "src/infrastructure/ledger/ledger-register.ts :: VerifiedRegisterSnapshot.rows.evidenceSnapshotId", why: "immutable evidence snapshot identifier" },
  { ref: "src/infrastructure/ledger/ledger-rows.ts :: DecisionLedgerRow.evidenceSnapshotId", why: "immutable evidence snapshot identifier" },
  { ref: "src/infrastructure/ledger/ledger-rows.ts :: DbLedgerRow.evidence_snapshot_id", why: "immutable evidence snapshot identifier" },
  { ref: "src/infrastructure/ledger/ledger-schema-registry.ts :: RecordedLedgerCodec.parse.<call>.return.evidenceSnapshotRef", why: "retained codec evidence snapshot reference" },
  { ref: "src/infrastructure/ledger/ledger-schema-registry.ts :: RecordedLedgerCodec.parse.return.evidenceSnapshotRef", why: "retained codec evidence snapshot reference" },
  { ref: "src/infrastructure/ledger/ledger-schema-registry.ts :: ParseResult.event.evidenceSnapshotRef", why: "retained codec evidence snapshot reference" },
  { ref: "src/infrastructure/ledger/ledger-source-integrity.ts :: ReplaySourceCoverageRow.orphan_evidence", why: "orphan row count" },
  { ref: "src/infrastructure/ledger/ledger-source-provenance.ts :: BindingRow.evidence_snapshot_id", why: "immutable evidence snapshot identifier" },
  { ref: "src/infrastructure/ledger/ledger-source-registry.ts :: ReplaySourceTypes.evidence", why: "typed immutable replay source" },
  { ref: "src/infrastructure/ledger/ledger-source-registry.ts :: ReplaySourceTypes.bundle.evidenceSnapshotRefs", why: "immutable evidence snapshot references" },
  { ref: "src/infrastructure/ledger/ledger-store.ts :: RecordDecisionInput.evidenceSnapshots", why: "typed immutable evidence snapshot references" },
  { ref: "src/infrastructure/ledger/ledger-store.ts :: RecordDecisionInput.inputBundle.evidenceSnapshotRefs", why: "immutable evidence snapshot references" },
  { ref: "src/infrastructure/ledger/ledger-store.ts :: RecordDecisionInput.events.evidenceSnapshotRef", why: "immutable evidence snapshot reference" },
  { ref: "src/infrastructure/ledger/ledger-store.ts :: PreparedEvent.event.evidenceSnapshotRef", why: "immutable evidence snapshot reference" },
  { ref: "src/infrastructure/ledger/ledger-structural-validator.ts :: StructuralLedgerEntry.event.evidenceSnapshotRef", why: "immutable evidence snapshot reference" },
  { ref: "src/infrastructure/ledger/ledger-structural-validator.ts :: LedgerStructureLookup.evidenceRecording", why: "evidence recording lookup function" },
  { ref: "src/infrastructure/ledger/ledger-structural-validator.ts :: LedgerStructureLookup.entry.<call>.return.event.evidenceSnapshotRef", why: "immutable evidence snapshot reference" },
  { ref: "src/infrastructure/ledger/ledger-structural-validator.ts :: LedgerStructureLookup.decisionRecording.<call>.return.event.evidenceSnapshotRef", why: "immutable evidence snapshot reference" },
  { ref: "src/infrastructure/ledger/ledger-structural-validator.ts :: LedgerStructureLookup.evidenceRecording.<call>(evidenceId)", why: "immutable evidence snapshot identifier" },
  { ref: "src/infrastructure/ledger/ledger-structural-validator.ts :: LedgerStructureLookup.evidenceRecording.<call>.return.event.evidenceSnapshotRef", why: "immutable evidence snapshot reference" },
  { ref: "src/infrastructure/ledger/ledger-structural-validator.ts :: LedgerStructureLookup.activeReservation.<call>.return.event.evidenceSnapshotRef", why: "immutable evidence snapshot reference" },
  { ref: "src/infrastructure/ledger/ledger-structural-validator.ts :: LedgerStructureLookup.approvalEscalations.<call>.return.event.evidenceSnapshotRef", why: "immutable evidence snapshot reference" },
  { ref: "src/infrastructure/ledger/ledger-structural-validator.ts :: LedgerStructureLookup.executionHandleEvents.<call>.return.event.evidenceSnapshotRef", why: "immutable evidence snapshot reference" },
  { ref: "src/infrastructure/ledger/ledger-structural-validator.ts :: LedgerStructureLookup.entry.return.event.evidenceSnapshotRef", why: "immutable evidence snapshot reference" },
  { ref: "src/infrastructure/ledger/ledger-structural-validator.ts :: LedgerStructureLookup.decisionRecording.return.event.evidenceSnapshotRef", why: "immutable evidence snapshot reference" },
  { ref: "src/infrastructure/ledger/ledger-structural-validator.ts :: LedgerStructureLookup.evidenceRecording(evidenceId)", why: "immutable evidence snapshot identifier" },
  { ref: "src/infrastructure/ledger/ledger-structural-validator.ts :: LedgerStructureLookup.evidenceRecording.return.event.evidenceSnapshotRef", why: "immutable evidence snapshot reference" },
  { ref: "src/infrastructure/ledger/ledger-structural-validator.ts :: LedgerStructureLookup.activeReservation.return.event.evidenceSnapshotRef", why: "immutable evidence snapshot reference" },
  { ref: "src/infrastructure/ledger/ledger-structural-validator.ts :: LedgerStructureLookup.approvalEscalations.return.event.evidenceSnapshotRef", why: "immutable evidence snapshot reference" },
  { ref: "src/infrastructure/ledger/ledger-structural-validator.ts :: LedgerStructureLookup.executionHandleEvents.return.event.evidenceSnapshotRef", why: "immutable evidence snapshot reference" },
  { ref: "src/infrastructure/ledger/ledger-structural-validator.ts :: StructuralRules.assertDecisionClaims.<call>(event).evidenceSnapshotRef", why: "immutable evidence snapshot reference" },
  { ref: "src/infrastructure/ledger/ledger-structural-validator.ts :: StructuralRules.assertPlanReferences.<call>(event).evidenceSnapshotRef", why: "immutable evidence snapshot reference" },
  { ref: "src/infrastructure/ledger/ledger-structural-validator.ts :: StructuralRules.assertDecisionClaims(event).evidenceSnapshotRef", why: "immutable evidence snapshot reference" },
  { ref: "src/infrastructure/ledger/ledger-structural-validator.ts :: StructuralRules.assertPlanReferences(event).evidenceSnapshotRef", why: "immutable evidence snapshot reference" },
  { ref: "src/infrastructure/ledger/ledger-verification.ts :: LedgerSnapshot.rows.evidenceSnapshotId", why: "immutable evidence snapshot identifier" },
  { ref: "src/contracts/decision-core/ledger-v1/ledger.ts :: LedgerEntry.evidenceSnapshotRef", why: "immutable evidence snapshot reference" },
  { ref: "src/contracts/decision-core/ledger-v1/ledger.ts :: EvidenceSnapshotRecorded.evidenceSnapshotRef", why: "immutable evidence snapshot reference" },
  { ref: "src/contracts/decision-core/ledger-v1/ledger.ts :: StatusObserved.evidenceSnapshotRef", why: "immutable evidence snapshot reference" },
  { ref: "src/contracts/decision-core/v1-7/decision.ts :: DecisionRecord.explanationTrace.evidenceSnapshotRefs", why: "immutable evidence snapshot references" },
  { ref: "src/contracts/decision-core/v1-7/decision.ts :: DecisionRecord.reevaluateWhen.evidenceKind", why: "machine evidence-kind discriminator" },
  { ref: "src/contracts/decision-core/v1-7/evidence.ts :: DecisionInputBundle.evidenceSnapshotRefs", why: "immutable evidence snapshot references" },
  { ref: "src/contracts/decision-core/v1-8/evidence.ts :: DecisionInputBundleV1_8_0.evidenceSnapshotRefs", why: "immutable evidence snapshot references" },
  { ref: "src/contracts/decision-core/v1-8/evidence.ts :: DecisionInputBundle.evidenceSnapshotRefs", why: "immutable evidence snapshot references" },
  { ref: "src/contracts/decision-core/v1-8/serialization.ts :: BundleHashPayloadV1_8_0.evidenceSnapshotRefs", why: "immutable evidence snapshot references" },
  { ref: "src/contracts/decision-core/v1-8/serialization.ts :: BundleHashPreimage.payload.evidenceSnapshotRefs", why: "immutable evidence snapshot references" },
  { ref: "src/contracts/decision-core/v1-8/serialization.ts :: NormalizableDecisionInputBundle.evidenceSnapshotRefs", why: "immutable evidence snapshot references" },
];
...
describe("llm-pii-boundary fence (v3 invariant 1)", () => {
  ...
  describe("detects (companion): planted leaks are caught", () => {
    ...
    it("rejects createRequire reached through a bound Reflect.get wrapper", () => {
      const project = inMemoryProject({
        "/src/contracts/pii.ts": marker,
        "/src/domain/schema/entities.ts": `import type { PIIBearing } from "@contracts/pii"; export interface Contact extends PIIBearing { firstName: string }`,
        "/src/infrastructure/llm/evil.ts": `
    ...
    it.each([
      ...
      `const holder = { mod: nodeModule };
          const req = holder.mod.createRequire(import.meta.url);`,
      `const holder = [nodeModule] as const;
          const req = holder[0].createRequire(import.meta.url);`,
      `const [held] = [nodeModule] as const;
          const req = held.createRequire(import.meta.url);`,
      ...
      `const holder = [{}, nodeModule] as const;
          ...
          const req = (holder[index] as typeof nodeModule).createRequire(import.meta.url);`,
