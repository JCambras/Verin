...
// contracts 5991/6050 (59), domain 1584/1650 (66), infrastructure
// 7173/7200 (27). These are the real figures, not a stale decision-table
...
const CEILINGS = {
  ...
  infrastructure: 7200, // ADR-0041, on ADR-0038's baseline plus the ledger store, sources, projections, and verifier
