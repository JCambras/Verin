...
// contracts 5947/6000 (53), domain 1583/1650 (67), infrastructure
// 6278/6300 (22). These are the real figures, not a stale decision-table
...
const CEILINGS = {
  ...
  infrastructure: 6300, // ADR-0041, on ADR-0038's baseline plus the ledger store, sources, projections, and verifier
