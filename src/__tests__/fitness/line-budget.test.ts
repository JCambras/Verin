...
// contracts 5951/6000 (49), domain 1584/1650 (66), infrastructure
// 6507/6550 (43). These are the real figures, not a stale decision-table
...
const CEILINGS = {
  ...
  infrastructure: 6550, // ADR-0041, on ADR-0038's baseline plus the ledger store, sources, projections, and verifier
