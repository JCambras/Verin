...
const REVIEWED_ESCAPES: Array<{ ref: string; why: string }> = [
  ...
  { ref: "src/infrastructure/ledger/ledger-structural-store.ts :: storedLedgerStructureLookup.approvalEscalations", why: "closure captures asserted tenant authority" },
  { ref: "src/infrastructure/ledger/ledger-structural-store.ts :: storedLedgerStructureLookup.executionHandleEvents", why: "closure captures asserted tenant authority" },
...
const PORT_ESCAPES = new Set([
  ...
  "src/domain/ledger/approval-authority.ts :: initialApprovalStageAuthority.<call>",
  "src/domain/ledger/approval-authority.ts :: applyApprovalStageEscalation.<call>",
  "src/domain/ledger/approval-authority.ts :: effectiveApprovalStageAuthority.<call>",
