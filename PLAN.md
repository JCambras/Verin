...
- **D-104** - the three prompt-8 primitive-catalog obligations: prompt 10 owes the fail-closed
  ...
  de-duplication and the per-`(claimKind, snapshotRef)` aggregation question.
