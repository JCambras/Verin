 ...
 * row carrying record_origin=world-fixture, which is what the clean-slate check
 * counts - the ROW's origin never moves, while the provenance of a value in it
 * does the moment somebody edits it. Their values land source=fixture while the
