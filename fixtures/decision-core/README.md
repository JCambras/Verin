...
compensation, canonicalize set-like evaluator inputs, record the IANA time-zone-data registry version
against the supported-registry map (so a recorded bundle stays replayable against the release it names),
