...
- the strict `verin-real-derived-replay/1.9.0` payload: entity-kind-scoped destination, ownership,
...
- semantic contract `verin-real-derived-semantics/1.10.0`; its declarative bytes and the complete
