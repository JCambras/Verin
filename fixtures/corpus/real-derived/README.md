...
- the strict `verin-real-derived-replay/1.2.0` payload: entity-kind-scoped destination, ownership,
...
- semantic contract `verin-real-derived-semantics/1.1.0`; its declarative bytes and the exact sources of
