...
`verin-corpus/1.10.0` digest covers each inventory entry's partition, case id, bytes, label kind, and label
...
canonical semantic projection. It binds `verin-real-derived-semantics/1.5.0`, including the closed
