...
const SEAM_MODULES = ["enforcement/contract.mjs", "src/access/context.ts", "src/evidence/bundle.ts", "src/policy/registry.ts"]; // the declared seam's home per slice; slice 2 adds exactly AccessContext (captain ruling 2026-08-20, GD-002), slice 3 adds exactly EvidenceBundle (GD-004), slice 4 adds exactly PolicyVersionRegistry (GD-006), and any later addition is its own recorded per-slice change
