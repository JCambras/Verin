# ADR-0058: The domain configuration schema - a decision domain is data
...
row twice, and the version checked would not provably be the version driven (D-246/D-255). A MISSING
