...
| [0029](./0029-decision-core-contracts.md) | Decision-core canonical contracts (v3 prompt 5) as Zod schemas in `contracts/`; ceiling re-baseline 600→2200 | Accepted (amends ADR-0018) |
