...
| [0030](./0030-gate-a-invariant-ordering.md) | Gate A requires invariants 1, 2, 4, 5; invariant 3 is gated at B (its prerequisite is prompt 10) | Accepted (amends ADR-0023) |
