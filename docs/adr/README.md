...
| [0030](./0030-gate-a-invariant-ordering.md) | Gate A owns invariants 1, 2, 4, 5 and requires prompt-5 guarantees 7, 8, 9; invariant 3 is gated at B | Accepted (amends ADR-0023) |
...
[`../v3/README.md`](../v3/README.md) (the ratified v3 architecture direction, ADR-0023..0030).
