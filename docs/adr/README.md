...
| [0058](./0058-domain-configuration-schema.md) | The domain configuration schema (v3 prompt 10): a decision domain is DATA - thirteen sections, seven-stage total loader, firm binder, plan compiler; the hand-coded account-opening flow is deleted; invariant 3 activates | Accepted (amends ADR-0010, ADR-0011) |
| [0059](./0059-line-budget-domain-configuration.md) | Contracts, domain, and infrastructure ceilings for the domain-configuration schema and its review rounds | Accepted (amends ADR-0054) |
