...
before any durable fourth-generation code, schema, migration, or production-path PR may merge. After
architecture ratification, a separate EXECUTABLE enforcement contract boundary must land first.
Disposable experiments may not be promoted into durable work in place of that enforcement.
