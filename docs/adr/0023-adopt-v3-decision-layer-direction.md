...
evidence; it selects no replacement architecture; the four-layer composition this adoption lands the
v3 module map inside stays binding on current Verin and as fourth-generation oracle evidence; neither
binds fourth-generation composition unless the later F8 captain ratification explicitly adopts it)
