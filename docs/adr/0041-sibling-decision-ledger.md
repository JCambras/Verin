...
- Amend the ADR-0018 ceilings, re-measured on the composed tree that already
  ...
  domain 1,350 to 1,600, and infrastructure 3,550 to 4,650. Measured state is
  contracts 5,851 (49 headroom), domain 1,576 (24), and infrastructure 4,608
  (42) - bounded correction room, per the ADR-0033 rule that a zero-headroom
  ceiling just converts review findings into documentation deletions. The
  presentation envelope and the per-file 500-line limit are unchanged.
