...
| V14 | Low | Outbox: no scheduled drainer, no poison handling | **Deferred** — inline drain + scheduled verify today. **Trigger:** deploy-target selection (add a scheduled drainer + max-attempts/dead-letter). |
