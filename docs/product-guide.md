...
explicitly adopts it. The thesis below is not a composition mandate. ADR-0060 deliberately leaves
product-story authority open, and this document still binds nothing on its own.
