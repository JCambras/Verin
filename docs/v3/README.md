...
| [`verin-core-contracts.ts`](./verin-core-contracts.ts) | Canonical decision-core contracts (reference document, NOT compiled product code - it lands as `src/contracts/decision-core` in Wave A prompt 5, Zod-wrapped at boundaries) |
